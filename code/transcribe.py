            ...
            while not self.shutdown_performed:
                ...
                if self.recorder and speech_end_silence_start is not None and speech_end_silence_start != 0:
                    ...
                    if time_since_silence > potential_sentence_end_time:
                        ...
                        # Only detect once per timeout period to prevent duplicates
                        if not hasattr(self, '_last_timeout_detection') or (now - self._last_timeout_detection) > 1.0:
                            ...
                            self._last_timeout_detection = now
